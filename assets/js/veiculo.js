...
(function () {
  ...
  function render(v, all, semelhantesPre) {
    ...
    $("#vehicle").innerHTML =
      ...
      '<div class="row2"><button class="btn btn-outline" type="button" id="btn-sim">' + icon("calc") + ' Simular financiamento</button><a class="btn btn-outline" href="venda-seu-veiculo.html">' + icon("tag") + " Vender meu veículo</a></div></div>" +
