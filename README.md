...
- Fonte Inter hospedada no próprio site (`assets/fonts/inter-latin.woff2`, licença SIL OFL, arquivo variável do Google Fonts): nenhuma conexão com o Google só para carregar a fonte.
